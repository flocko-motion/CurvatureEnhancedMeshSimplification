...
class STLReader
{
    ...
    public static ArrayList<Triangle> readBinary(byte[] allBytes)
    {
        ...
        HashMap<Vector, Vertex> verticesUnique = new HashMap<Vector, Vertex>();
        try{
            // skip the header
            ...
            try{
                while(in.available() > 0 ){
                    ...
                    Vector normal = new Vector(xyz[0],xyz[1],xyz[2]);
                    ...
                    for (int v = 0; v < verticesTriangle.length; v++) {
                        ...
                        Vector vertexCoordinates = new Vector(xyz[0], xyz[1], xyz[2]);
